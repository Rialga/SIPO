...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            <input type="password" name="userPassword" class="form-control" wire:model.lazy ="userPassword" required/>
...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        <div class="input-group">
            <input type="password" name="retypePassword" class="form-control" wire:model.lazy ="retypePassword" required/>
        </div>
